...
import org.scalajs.dom.{ document, Document, Element }

import com.greencatsoft.scales.dom.{ ElementRegistry, ElementRegistrationOptions }
...
object ComponentRegistry {
  ...
  def metadata[A <: Component[_]]: ComponentDefinition[_] = ???
}